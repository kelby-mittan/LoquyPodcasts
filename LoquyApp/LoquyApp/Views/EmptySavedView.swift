    ...
    var body: some View {
        ...
        ZStack {
            ...
            ZStack {
                ...
                getSineWave(interval: universalSize.width*1.4, amplitude: 160, baseLine: 50+universalSize.width/1.2)
                ...
                getSineWave(interval: universalSize.width*1.1, amplitude: 120)
