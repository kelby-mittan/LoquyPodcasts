...
struct DummyPodcast: Identifiable, Hashable {
    ...
    static let mindspace = DummyPodcast(title: "Mindscape", host: "Sean Carrol", category: "Physics", image: "mindscape", description: "Ever wanted to know how music affects your brain, what quantum mechanics really is, or how black holes work? Do you wonder why you get emotional each time you see a certain movie, or how on earth video games are designed? Then you’ve come to the right place. Each week, Sean Carroll will host conversations with some of the most interesting thinkers in the world. From neuroscientists and engineers to authors and television producers, Sean and his guests talk about the biggest ideas in science, philosophy, culture and much more.", guest: "Scott Miles", rating: "4.0", feedUrl: "https://rss.art19.com/sean-carrolls-mindscape")
    ...
    static let podcasts = [
        ...
        DummyPodcast(title: "Breaking Points", host: "Krystall and Sagaar", category: "All", image: "breakingPointsOne", description: "Krystall and Sagaar rock", guest: "", rating: "4.0", feedUrl: "https://feeds.simplecast.com/_iafZVRs"),
        ...
        DummyPodcast(title: "The Portal", host: "Eric Weinstein", category: "Mathematics", image: "thePortal", description: "", guest: "Bret Weinstein", rating: "4.5", feedUrl: "https://rss.art19.com/the-portal"),
        DummyPodcast(title: "Real Talk with Zuby", host: "Zuby", category: "Everything", image: "realTalkZuby", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://feeds.simplecast.com/G8Yf4zG5"),
        DummyPodcast(title: "Swift by Sundell", host: "John Sundell", category: "Tech", image: "swiftSundell", description: "", guest: "Alex Paul", rating: "4.5", feedUrl: "https://swiftbysundell.com/podcast/feed.rss"),
        DummyPodcast(title: "Rebel Wisdom", host: "Tristan Harris", category: "Philosophy", image: "rebel", description: "", guest: "Sam Harris", rating: "4.0", feedUrl: "https://rebelwisdom.podbean.com/feed.xml"),
        DummyPodcast(title: "WTF", host: "Marc Maron", category: "Comedy", image: "wtf", description: "", guest: "Dave Chapelle", rating: "3.5", feedUrl: "https://www.omnycontent.com/d/playlist/aaea4e69-af51-495e-afc9-a9760146922b/8a755b22-8f72-4d44-8ff9-ab79013fda25/6b8a5068-9bea-439f-bd4d-ab79013fda2b/podcast.rss"),
        DummyPodcast(title: "Reset", host: "VOX", category: "Philosophy", image: "reset", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://feeds.megaphone.fm/VMP9176219298"),
        DummyPodcast(title: "The Next Big Idea", host: "Wondery", category: "All", image: "nextBigIdea", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://rss.art19.com/the-next-big-idea"),
        DummyPodcast(title: "Smartless", host: "Jason Bateman", category: "Comedy", image: "smartless", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://feeds.simplecast.com/pvzhyDQn"),
        DummyPodcast(title: "The Daily Show", host: "Trevor Noah", category: "Comedy", image: "noah", description: "", guest: "", rating: "4.0", feedUrl: "https://feeds.megaphone.fm/the-daily-show"),
        DummyPodcast(title: "The Right Time", host: "Bomani Jones", category: "Sports", image: "rightTimeBomani", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://feeds.megaphone.fm/ESP4820632502"),
        DummyPodcast(title: "Stuff You Should Know", host: "", category: "Science", image: "youShouldKnow", description: "", guest: "Scott Miles", rating: "4.0", feedUrl: "https://feeds.megaphone.fm/stuffyoushouldknow"),
        DummyPodcast(title: "Science Salon", host: "Michael Schermer", category: "Science", image: "scienceSalon", description: "", guest: "", rating: "4.0", feedUrl: "https://sciencesalon.libsyn.com/rss"),
        DummyPodcast(title: "Dan Carlin's Hardcore History: Addendum", host: "Dan Carlin", category: "Politics", image: "hchAddendum", description: "", guest: "", rating: "4.0", feedUrl: "https://dchhaddendum.libsyn.com/rss"),
        DummyPodcast(title: "NPR Politics Podcast", host: "", category: "Politics", image: "nprPolitics", description: "", guest: "Dylan Ratigan", rating: "4.0", feedUrl: "https://feeds.npr.org/510310/podcast.xml"),
        DummyPodcast(title: "Up First", host: "NPR", category: "Literature", image: "npr", description: "The Artificial Intelligence (AI) podcast hosts accessible, big-picture conversations at MIT and beyond about the nature of intelligence with some of the most interesting people in the world thinking about AI from the perspective of deep learning, robotics, AGI, neuroscience, philosophy, psychology, cognitive science, economics, physics, mathematics, and more.", guest: "Howard Stern", rating: "3.0", feedUrl: "https://feeds.npr.org/510318/podcast.xml"),
        DummyPodcast(title: "WTF", host: "Marc Maron", category: "Comedy", image: "wtf", description: "", guest: "Dave Chapelle", rating: "3.5", feedUrl: "https://www.omnycontent.com/d/playlist/aaea4e69-af51-495e-afc9-a9760146922b/8a755b22-8f72-4d44-8ff9-ab79013fda25/6b8a5068-9bea-439f-bd4d-ab79013fda2b/podcast.rss")]
